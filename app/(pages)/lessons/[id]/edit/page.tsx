    ...
    <div className="flex flex-col h-full overflow-hidden bg-bg-base">
      ...
      <div className="sticky top-0 z-20 flex items-center justify-between px-4 md:px-6 py-4 border-b border-white/5 bg-bg-surface/80 backdrop-blur-md">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base md:text-lg font-bold text-text-primary">Edit Lesson</h1>
            <p className="text-[10px] uppercase tracking-wider text-text-muted font-bold hidden md:block">Refine Content</p>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto p-4 md:p-8 space-y-8">
          ...
          <section className="space-y-4">
            ...
            <RichTextEditor
              content={content}
              onChange={setContent}
              placeholder="Refine your lesson content..."
            />
          </section>
